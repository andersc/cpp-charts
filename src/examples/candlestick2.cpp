...
int main(){
    ...
    while (!WindowShouldClose()){
        ...
        // Titles
        DrawText("valuesPerCandle=1, visible=30", (int)(lR1.x + 10), (int)(lR1.y + 10), 18, {220, 220, 230, 200});
        DrawText("valuesPerCandle=1, visible=50 (alt colors)", (int)(lR2.x + 10), (int)(lR2.y + 10), 18, {220, 220, 230, 200});
        DrawText("valuesPerCandle=1, visible=20", (int)(lR3.x + 10), (int)(lR3.y + 10), 18, {220, 220, 230, 200});
        ...
        if (lData.empty()){
            ...
            DrawText("Streaming 1 row per 0.5sec (1 value per candle) from JPM_1_minute_bars.csv", 20, lScreenH - 28, 20, {200, 200, 210, 255});
        }
